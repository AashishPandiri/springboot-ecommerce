...
public class JWTServiceTest {
    ...
    public void testResetPasswordJWTNotGeneratedByUs(){
        String token = JWT.create().withClaim("RESET_PASSWORD_EMAIL", "UserA@junti.com").sign(Algorithm.HMAC256(
                "NotTheRealSecret"
        ));
    ...
    public void testResetPasswordJWTCorrectlySignedNoIssuer(){
        String token = JWT.create().withClaim("RESET_PASSWORD_EMAIL", "UserA@junti.com").sign(Algorithm.HMAC256(algorithmKey));
