...
public class WebsocketConfiguration implements WebSocketMessageBrokerConfigurer {
    ...
    public WebsocketConfiguration(AuthorizationContext context, JWTRequestFilter jwtRequestFilter, UserService userService) {
    ...
    public void configureClientInboundChannel(ChannelRegistration registration) {
        ...
        AuthorizationEventPublisher publisher =
                new SpringAuthorizationEventPublisher((ApplicationEventPublisher) context);
